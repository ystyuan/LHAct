...
def get_args():
    ...
    parser.add_argument('--threshold_h', default=1.3520756840705868, type=float, help='sparsity level')
    parser.add_argument('--threshold_l', default=0.21940805315971373, type=float, help='sparsity level')
